...
export default function NovaReceitaPage() {
  ...
  // rastreia se as dicas foram adicionadas automaticamente (sem edição manual)
  const [dicasAutoAdicionadas, setDicasAutoAdicionadas] = useState(false)
  // prompt inline para confirmar ação sobre as dicas
  ...
  return (
    <>
      ...
      <div className="max-w-lg mx-auto p-4 pb-10 space-y-4">
        ...
        {/* Prompt: adicionar dicas de sopa? (notas manuais existentes) */}
        {dicasPrompt === 'add' && (
          <div className="bg-[#2D5016]/5 border border-[#2D5016]/20 rounded-xl p-3 space-y-2">
            ...
            <div className="flex gap-2">
              <button
                type="button"
                onClick={confirmarAdicionarDicas}
        ...
        {/* Prompt: remover dicas de sopa ao mudar categoria? */}
        {dicasPrompt === 'remove' && (
        ...
        <div className="space-y-1">
          ...
          <Input
            placeholder="Uma canja reconfortante..."
        ...
        <div className="space-y-1">
          ...
          <Textarea
            rows={3}
            placeholder="Pode fazer-se de véspera..."
        ...
        <div className="space-y-1">
          ...
          <Input
            placeholder="vegetariano, rápido, económico"
            value={form.tags}
